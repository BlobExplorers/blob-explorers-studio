export default function CreatorWorld() {
  return (
    ...
    >
      <div
        aria-hidden="true"
        className="pointer-events-none absolute left-1/2 top-1/2 h-72 w-72 -translate-x-1/2 -translate-y-1/2 rounded-full bg-violet-500/[0.02] sm:h-[420px] sm:w-[420px]"
      />

      <div className="relative mx-auto max-w-6xl overflow-hidden rounded-[2rem] border border-violet-400/20 bg-gradient-to-br from-violet-950/70 via-black/70 to-emerald-950/60 p-5 text-center sm:p-8 md:p-12 lg:p-16">
        <div className="relative">
          <p className="text-xs font-bold uppercase tracking-[0.24em] text-yellow-400 sm:text-sm sm:tracking-[0.35em]">
            The Final World
          </p>

          <div className="mx-auto mt-7 flex h-20 w-20 items-center justify-center rounded-full border border-violet-300/30 bg-violet-400/10 text-3xl sm:mt-8 sm:h-24 sm:w-24 sm:text-4xl">
            🔒
          </div>
          ...
          <div className="mx-auto mt-8 grid max-w-3xl gap-4 sm:mt-10 sm:grid-cols-3">
            ...
            <div className="rounded-2xl border border-white/10 bg-black/20 p-5">
              ...
              <p className="mt-2 font-black text-white">77</p>
            </div>
            ...
            <div className="rounded-2xl border border-white/10 bg-black/20 p-5">
              ...
              <p className="mt-2 font-black text-violet-300">Locked</p>
            </div>
          </div>
