      ...
      <div className="glass-panel mx-auto max-w-7xl rounded-2xl">
        <div className="flex items-center justify-between px-5 py-3 md:px-7">
          <Link href="/" className="group flex items-center gap-3">
            <div className="relative h-12 w-12 overflow-hidden rounded-full border-2 border-emerald-400/80 shadow-[0_0_28px_rgba(16,185,129,0.35)] transition duration-300 group-hover:scale-105 group-hover:shadow-[0_0_36px_rgba(16,185,129,0.55)]">
              <Image
